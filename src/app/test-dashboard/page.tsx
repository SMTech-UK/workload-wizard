    ...
    <div className="container mx-auto p-6 space-y-6 max-w-full overflow-hidden">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2 border border-gray-200 dark:border-gray-700 flex items-center gap-2">
      ...
      {/* Warning Display for Test Failures */}
      {displayReport && displayReport.summary.failed > 0 && !error && (
        <Alert variant="default" className="border-yellow-200 bg-yellow-50">
          <AlertTriangle className="h-4 w-4 text-yellow-600" />
          <AlertTitle className="text-yellow-800">Test Failures Detected</AlertTitle>
          <AlertDescription className="text-yellow-700">
            {displayReport.summary.failed} out of {displayReport.summary.total} tests failed. Review the results below for details.
          </AlertDescription>
        </Alert>
      )}
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6 max-w-full overflow-hidden">
        ...
        <TabsContent value="coverage" className="space-y-4">
          ...
          <Card>
            ...
            <CardContent>
              {displayReport && displayReport.coverageDetails ? (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                      <div className="text-2xl font-bold text-blue-600">
                        {displayReport.coverageDetails.statements.toFixed(1)}%
                      </div>
                      <div className="text-sm text-gray-600">Statements</div>
                    </div>
                    <div className="text-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                      <div className="text-2xl font-bold text-green-600">
                        {displayReport.coverageDetails.branches.toFixed(1)}%
                      </div>
                    <div className="text-sm text-gray-600">Branches</div>
                  </div>
                    <div className="text-center p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                      <div className="text-2xl font-bold text-yellow-600">
                        {displayReport.coverageDetails.functions.toFixed(1)}%
                      </div>
                    <div className="text-sm text-gray-600">Functions</div>
                    </div>
                    <div className="text-center p-3 bg-purple-100 dark:bg-purple-900/30 rounded-lg">
                      <div className="text-2xl font-bold text-purple-600">
                        {displayReport.coverageDetails.lines.toFixed(1)}%
                      </div>
