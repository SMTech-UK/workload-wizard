  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full bg-white dark:bg-black animate-fade-in">
      <div className="flex items-center gap-3 mb-4">
        ...
        <span className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight select-none">WorkloadWizard</span>
      </div>
      <div className="h-2 w-32 bg-blue-100 dark:bg-blue-900 rounded-full overflow-hidden">
        <div
